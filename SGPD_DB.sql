...
(
ID INT NOT NULL,
TITULO VARCHAR (50) NOT NULL,/*ES EL TITULO DEL APARTADO DE CADA SECCION*/
...
(
ID INT, /*PK*/
MOTIVO VARCHAR (50),/*MENSAJE TITULO DE LA NOTIFICACION*/
MENSAJE VARCHAR (350),/*MENSAJE QUE SE ENVIARA COMO NOTIFICACION*/
EMISOR INT, /*ES USUARIO*/
LEIDO TINYINT(1) DEFAULT 0,/*BOOLEAN*/
...
ADD CONSTRAINT PK_SECCION_PAGINA PRIMARY KEY (ID);/*CREACION DE PK PREGUNTA*/
...
ALTER TABLE SECCION_FORMULARIO
ADD CONSTRAINT FK_SECCIONFORMULARIO_FORMULARIO
...
ON DELETE CASCADE;/*CREACION DE FK MUNICIPIO*/
