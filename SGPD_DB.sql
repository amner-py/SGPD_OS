...
(
ID INT, /*PK*/
LUGAR_ID INT, /*LUGAR AL QUE SE LE ASIGNARA */
DELEGACION_ID INT /*FK*/
)ENGINE=Innodb;
...
ADD CONSTRAINT PK_ASIGNACION PRIMARY KEY (ID);/* CREACION DE PK ASIGNACION*/
...
ON DELETE SET NULL; /* CREACION DE FK ASIGNACION*/
