...
let respuesta_id = document.querySelector('#respuesta_id').value
        ...
        swal.fire({
            ...
            hideClass: {
              popup: 'animate__animated animate__fadeOutUp'
                ...
                if(isConfirm){
                  location.href="/respuesta/respuestas/area_operativa/"
                }
            })
    }else{
        swal.fire({
...
const validation=()=>{
    ...
    jd={
        ...
        'plan':parseInt(plan.value|0),
        'operativo':parseInt(operativo.value|0),
